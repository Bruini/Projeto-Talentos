...
var DatatableJsonRemoteDemo = function () {
	...
	var demo = function () {
        ...
        var datatableApi = $('#api_data').mDatatable({
            // datasource definition
            translate: {
                records:{
			...
			data: {
				...
				source: {
                    method: 'POST',
                    url: 'http://localhost:50018/api/ParametrosNegocio?paginaAtual=1&totalPorPagina=10'
                },
                pageSize: 10,
